...
if ($_POST) {
    ...
    $sql = "DELETE FROM PRODUCTO WHERE codigo_producto = '$cc'";
    if ($connect->query($sql) === TRUE) {
        $valid['success'] = true;
        $valid['messages'] = "Producto eliminado correctamente";        
    } else {
        $valid['success'] = false;
        $valid['messages'] = "Error no se ha podido eliminar el producto";
    }
    ...
    $accion = "El usuario $nombre eliminó el producto $cc el $fecha";
