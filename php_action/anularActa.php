...
if($_POST) {	
	...
	$codigoActa = $_POST['codigoActa']; 
        ...
        $r = "UPDATE activo SET estado = 1 WHERE ACTA_codigo_acta = '$codigoActa'";
        $connect->query($r); 
	...
	$sql = "UPDATE acta SET estado = 0 WHERE codigo_acta = '$codigoActa'";
	if($connect->query($sql) === TRUE) {
	 	$valid['success'] = true;
		$valid['messages'] = "Acta anulado correctamente";	
	} else {
	 	$valid['success'] = false;
