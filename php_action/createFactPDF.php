...
if ($_POST) {
    ...
    $rs = $conexion->obtenerActivosOrden($codigoCertificacion);
    ...
    $contenidoHTML = '<html lang="en">
                ...
                <body>
                  <header class="clearfix">
                    <div id="logo">
                      <a href="../ingresos.php"><img src="' . $banner . '" border="1" width="400" height="175"></a>
                    </div>
                    <h1></h1>
                    <div id="company" class="clearfix">
                      <div><font size="5"><b>' . 'INGRESO  ' . $codigoCertificacion . '</b></font></div>
    ...
    $totalCert = "call obtenerTotalOrden('$codigoCertificacion',@total)";
    ...
    $nombre = "INGRESO_" . $codigoCertificacion . ".pdf";
    $salida = "ingresos/" . $nombre . "";
    $myPDF->Output("../" . $salida);
