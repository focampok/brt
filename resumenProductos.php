...
if ($resultado->num_rows > 0) {
    ...
    $titulosColumnas = array('CODIGO', 'FECHA', 'ESTADO', 'CANTIDAD', 'MARCA', 'MODELO', 'SERIE', 'DESCRIPCION', 'PRECIO', 'SUBTOTAL', 'BODEGA');
    ...
    while ($fila = $resultado->fetch_array()) {
        ...
        $hoja->setCellValue('K' . $i, $fila['CONTENEDOR_codigo_contenedor']);
    ...
    $nombreArchivo = "PRODUCTOS_" . $hoy['mday'] . "." . $hoy['mon'] . "." . $hoy["year"] . "_" . $hoy['hours'] . "." . $hoy['minutes'] . "." . $hoy['seconds'] . ".xlsx";
